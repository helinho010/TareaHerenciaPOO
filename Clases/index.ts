...
const med: Medico = new Medico("Ramon Quintana", "10151231-EN LP", "2252513", "Villa Fatmia, calle 15 de marzo #1202", 1.74, 75, 32, 3, 3300, "1005-e1", "Medico cirujano");
const messi: Jugador = new Jugador("Leonel Messi", "8362926 LP", "77633453", "Villa Pabon Calle Tte. Rosendo Villa #1515", 1.64, 55, 31, 5, 10500, "10-A1", "Volante armador", 10, 39);
